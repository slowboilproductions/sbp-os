...
**Status:** v0.3 — **RATIFIED at the operator's W2 merge (2026-06-13).** Approved at the skeleton gate ("good start… capture now"), audited PASS-WITH-NITS (nits swept), ratified by the operator's merge to `main`. Operator may still tweak in Step 2. · **Date:** 2026-06-13 · **Label:** INSTANCE · **Originating record:** `_SYSTEM/Session_Logs/2026-06-12_SBP-W1_SCL.md` (founding) + W2 gate-answers round (this bump)
...
*sbp-os canon — RATIFIED v0.3, W2. INSTANCE (SBP-specific). Ratified at the operator's merge to `main`, 2026-06-13. No open nodes remain in the skeleton.*
